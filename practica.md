...
| Tema | Tu respuesta | Correcta |
|------|--------------|----------|
| Costo mundial siniestros anual | 1 billón USD | **518.000 millones USD** |

**Backlog resuelto:** VTV motos (1 año), reducir velocidad 5% (30%), retención grupo 2/3 (cinturón), distribución peso (uniforme), costos PIB ricos (2%)

---

### Examen 8 - 2026-03-03 (Reid + Creando Conciencia)
...
| Tema | Tu respuesta | Correcta |
|------|--------------|----------|
| VTV obligatoria motovehículos | 3 años | **1 año** |
| Reducir velocidad 5% → muertes | 15% | **30%** |
| Retención infantil grupo 2/3 | Arnés 5 puntos | **Cinturón del vehículo** |
| Distribución peso cargas | Concentrado en el centro | **De manera uniforme** |
| Costos siniestros PIB países ricos | 1% | **2%** |

**Backlog resuelto:** Distancia mínima adelantar ciclista (1,5 metros)

---

### Examen 7 - 2026-03-03 (Reid + Creando Conciencia)
...
| Tema | Tu respuesta | Correcta |
|------|--------------|----------|
| Distancia mínima adelantar ciclista | 2 metros | **1,5 metros** |
| VTV obligatoria motovehículos | 3 años | **1 año** |

**Backlog resuelto:** Declaración DDHH (1948), Plazo renovar licencia (12 meses), Enfoque OMS (Sistema Seguro)
...
**Tipo:** Examen de conducir CABA

---

### Examen 2 - 2026-01-31 (Reid + Creando Conciencia)
...
| Tema | Tu respuesta | Correcta |
|------|--------------|----------|
| Renovación licencia mayores 70 años | Cada 2 años | **Cada año** |

**Backlog resuelto:** 10/10 preguntas del backlog respondidas correctamente.

---

### Examen 1 - 2026-01-31 (Reid)
...
| Tema | Tu respuesta | Correcta |
|------|--------------|----------|
| VTV autos | 2 años | **3 años o 60,000 km** |
| +1% velocidad → siniestro fatal | +10% | **+4%** |
| Alcohol rutas nacionales | 0.5 g/l | **0 g/l (Alcohol Cero)** |
| Certificación cascos | ISO 9001 | **CHAS** |
| Costos siniestros PIB | 3% | **1.5%** |
| Distancia balizas | 10m y 20m | **30m y 60m** |
| Número emergencias | 107 | **911** (107 es SAME) |
| Plazo seguro | 24 hrs | **72 hrs** |
